...
const CONST_PROVINCE_CODE = 14;
const CONST_PROVINCE_NAME = "RIAU";
const CONST_CITY_CODE = 1471;
const CONST_CITY_NAME = "KOTA PEKANBARU";

frappe.ui.form.on("PD DPT Kota Pekanbaru", {
  refresh(frm) {
    //
