...
const CONST_DEFAULT_REGION_CODE = "62",
  CONST_DEFAULT_REGION_GEOJSON = "Kalimantan Tengah",
...
frappe.ui.form.on("PD Peta Zona Pemenangan Kalimantan Tengah", {
  ...
  render_map: function (frm) {
    ...
    function renderMap(level, geoJsondata) {// Clear the existing map layers (e.g., when navigating to a new level)
