...
const CONST_DEFAULT_REGION_CODE = "1271",
  CONST_DEFAULT_REGION_GEOJSON = "Kota Medan",
  ...
  render_map: function (frm) {
    ...
    function generateZonasiTable(level, data) {
      ...
      tableHead += `
                ...
                <th style="text-align: right">DPTHP2 (2024)</th>
    ...
    function generateRelawanTable(level, data) {
      let tableHeadVillage = '';
      let tableHead = `
      <thead>
      <tr>`;

      if (parseInt(level) >= CONST_PROVINCE_LEVEL) {
        tableHead += `<th>KAB/ KOTA</th>`;
      }
